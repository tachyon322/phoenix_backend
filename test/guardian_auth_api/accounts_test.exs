defmodule GuardianAuthApi.AccountsTest do
  use GuardianAuthApi.DataCase

  alias GuardianAuthApi.Accounts

  describe "users" do
    alias GuardianAuthApi.Accounts.User

    import GuardianAuthApi.AccountsFixtures
